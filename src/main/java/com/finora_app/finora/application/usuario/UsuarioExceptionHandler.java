...
public class UsuarioExceptionHandler {
	...
	ResponseEntity<ErroResponse> corpoInvalido(HttpMessageNotReadableException exception) {
		return ResponseEntity.badRequest().body(new ErroResponse("Dados da requisicao invalidos"));
	}
